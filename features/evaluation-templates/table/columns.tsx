...
import { EvaluationTemplateRowActions } from "./EvaluationTemplateRowActions";

type CreateEvaluationTemplateColumnsOptions = {
  sortBy: string;
  sortOrder: "asc" | "desc";
...
export function createEvaluationTemplateColumns({
  sortBy,
  sortOrder,
  onSortChange,
  onEdit,
  onRefresh,
}: CreateEvaluationTemplateColumnsOptions): ColumnDef<EvaluationTemplateTableRow>[] {
  return [
    {
      accessorKey: "code",
      header: () => (
