...
type DocumentCategoryTableToolbarProps = {
  filters: DocumentCategoryFilterInput;
  onFiltersChange: (filters: Partial<DocumentCategoryFilterInput>) => void;
  onCreate: () => void;
};

export function DocumentCategoryTableToolbar({
  filters,
  onFiltersChange,
  onCreate,
}: DocumentCategoryTableToolbarProps) {
  const {
    value: searchValue,
    ...
    <TableToolbar>
      <div className="flex flex-1 flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <Select
          ...
          onValueChange={(value) =>
            onFiltersChange({
              isActive: value as DocumentCategoryFilterInput["isActive"],
              page: 1,
            })
          }
        >
