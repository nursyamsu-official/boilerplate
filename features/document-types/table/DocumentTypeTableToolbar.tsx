...
type DocumentTypeTableToolbarProps = {
...
export function DocumentTypeTableToolbar({
  filters,
  categoryOptions,
  onFiltersChange,
  onCreate,
}: DocumentTypeTableToolbarProps) {
  const {
    value: searchValue,
    ...
    <TableToolbar>
      <div className="flex flex-1 flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <Select
          ...
          onValueChange={(value) =>
            onFiltersChange({
              categoryId: value as DocumentTypeFilterInput["categoryId"],
              page: 1,
            })
          }
        >
        ...
        <Select
          ...
          onValueChange={(value) =>
            onFiltersChange({
              isActive: value as DocumentTypeFilterInput["isActive"],
              page: 1,
            })
          }
        >
