...
type ProvinceFormProps = {
  defaultValues: ProvinceFormValues;
  countryOptions: CountryOption[];
  submitLabel: string;
  pendingLabel: string;
  layout?: "default" | "dialog";
  submitConfig: FormActionSubmitConfig<ProvinceFormValues, unknown>;
  onCancel: () => void;
};
          ...
          <form.Field name="isActive">
            {(field) => (
              <SwitchField
                field={field}
                label="Active"
                description="Inactive provinces are hidden from selection lists."
              />
            )}
          </form.Field>
        </FieldGroup>
