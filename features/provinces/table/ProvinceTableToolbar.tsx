...
type ProvinceTableToolbarProps = {
...
export function ProvinceTableToolbar({
  filters,
  countryOptions,
  onFiltersChange,
  onCreate,
}: ProvinceTableToolbarProps) {
  const {
    value: searchValue,
    ...
    <TableToolbar>
      <div className="flex flex-1 flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <Select
          ...
          onValueChange={(value) =>
            onFiltersChange({
              countryId: value as ProvinceFilterInput["countryId"],
              page: 1,
            })
          }
        >
        ...
        <Select
          ...
          onValueChange={(value) =>
            onFiltersChange({
              isActive: value as ProvinceFilterInput["isActive"],
              page: 1,
            })
          }
        >
