...
import { EvaluationCriteriaRowActions } from "./EvaluationCriteriaRowActions";

type CreateEvaluationCriteriaColumnsOptions = {
  sortBy: string;
  sortOrder: "asc" | "desc";
...
export function createEvaluationCriteriaColumns({
  sortBy,
  sortOrder,
  onSortChange,
  onEdit,
  onRefresh,
}: CreateEvaluationCriteriaColumnsOptions): ColumnDef<EvaluationCriteriaTableRow>[] {
  return [
    {
