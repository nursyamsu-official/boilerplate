...
type OrganizationalUnitTableToolbarProps = {
    ...
    <TableToolbar>
      <div className="flex flex-1 flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <Select
          ...
          onValueChange={(value) =>
            onFiltersChange({
              companyId: value as OrganizationalUnitFilterInput["companyId"],
              page: 1,
            })
          }
        >
        ...
        <Select
          ...
          onValueChange={(value) =>
            onFiltersChange({
              isActive: value as OrganizationalUnitFilterInput["isActive"],
              page: 1,
            })
          }
        >
