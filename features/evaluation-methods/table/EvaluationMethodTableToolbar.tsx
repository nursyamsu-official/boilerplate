...
type EvaluationMethodTableToolbarProps = {
  filters: EvaluationMethodFilterInput;
  onFiltersChange: (filters: Partial<EvaluationMethodFilterInput>) => void;
  onCreate: () => void;
};

export function EvaluationMethodTableToolbar({
  filters,
  onFiltersChange,
  onCreate,
}: EvaluationMethodTableToolbarProps) {
  const {
    value: searchValue,
    ...
    <TableToolbar>
      <div className="flex flex-1 flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <Select
          ...
          onValueChange={(value) =>
            onFiltersChange({
              isActive: value as EvaluationMethodFilterInput["isActive"],
              page: 1,
            })
          }
        >
