...
type EvaluationScoringMethodTableToolbarProps = {
  filters: EvaluationScoringMethodFilterInput;
  onFiltersChange: (filters: Partial<EvaluationScoringMethodFilterInput>) => void;
  onCreate: () => void;
};

export function EvaluationScoringMethodTableToolbar({
  filters,
  onFiltersChange,
  onCreate,
}: EvaluationScoringMethodTableToolbarProps) {
  const {
    value: searchValue,
    ...
    <TableToolbar>
      <div className="flex flex-1 flex-col gap-2 sm:flex-row sm:items-center">
        <div className="relative w-full max-w-sm">
          ...
          <Input
            value={searchValue}
            placeholder="Search scoring methods..."
            className="pl-8"
        ...
        <Select
          ...
          onValueChange={(value) =>
            onFiltersChange({
              isActive: value as EvaluationScoringMethodFilterInput["isActive"],
              page: 1,
            })
          }
        >
