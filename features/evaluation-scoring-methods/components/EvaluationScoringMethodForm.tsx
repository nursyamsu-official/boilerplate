...
type EvaluationScoringMethodFormProps = {
  defaultValues: EvaluationScoringMethodFormValues;
  submitLabel: string;
  pendingLabel: string;
  layout?: "default" | "dialog";
  submitConfig: FormActionSubmitConfig<EvaluationScoringMethodFormValues, unknown>;
  onCancel: () => void;
};

export function EvaluationScoringMethodForm({
  defaultValues,
  submitLabel,
  pendingLabel,
  layout = "default",
  submitConfig,
  onCancel,
}: EvaluationScoringMethodFormProps) {
          ...
          <form.Field name="description">
            {(field) => (
              <TextareaField
                field={field}
                label="Description"
                placeholder="Brief description of the scoring method"
              />
            )}
          </form.Field>
          ...
          <form.Field name="isActive">
            {(field) => (
              <SwitchField
                field={field}
                label="Active"
                description="Inactive scoring methods are hidden from selection lists."
              />
            )}
          </form.Field>
        </FieldGroup>
