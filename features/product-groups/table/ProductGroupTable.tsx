...
import { ProductGroupTableToolbar } from "./ProductGroupTableToolbar";

type ProductGroupTableProps = {
  data: ProductGroupListResult;
  filters: ProductGroupFilterInput;
  isEditLoading?: boolean;
  onFiltersChange: (filters: Partial<ProductGroupFilterInput>) => void;
  onEdit: (country: ProductGroupTableRow) => void;
  onCreate: () => void;
  onRefresh: () => void;
};
    ...
    () =>
      createProductGroupColumns({
        ...
        onSortChange: (sortBy) => {
          ...
          onFiltersChange({
            sortBy: sortBy as ProductGroupFilterInput["sortBy"],
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <DataTable
        ...
        emptyDescription="Create your first product group to get started."
        onSortingChange={(nextSorting) => {
          const first = nextSorting[0];
          if (!first) return;

          onFiltersChange({
            sortBy: first.id as ProductGroupFilterInput["sortBy"],
