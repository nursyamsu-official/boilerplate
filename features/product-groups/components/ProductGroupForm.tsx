...
type ProductGroupFormProps = {
  ...
  submitConfig: FormActionSubmitConfig<ProductGroupFormValues, unknown>;
  onCancel: () => void;
};
          ...
          <form.Field name="description">
            {(field) => (
              <TextareaField
                field={field}
                label="Description"
                placeholder="Brief description of the product group"
              />
            )}
          </form.Field>
          ...
          <form.Field name="isActive">
            {(field) => (
              <SwitchField
                field={field}
                label="Active"
                description="Inactive product groups are hidden from selection lists."
              />
            )}
          </form.Field>
        </FieldGroup>
