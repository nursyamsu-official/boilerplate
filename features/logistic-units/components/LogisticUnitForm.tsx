...
type LogisticUnitFormProps = {
  defaultValues: LogisticUnitFormValues;
  companyOptions: CompanyOption[];
  excludeUnitId?: string;
  initialParentOptions?: LogisticUnitParentOption[];
  submitLabel: string;
  pendingLabel: string;
  layout?: "default" | "dialog";
  submitConfig: FormActionSubmitConfig<LogisticUnitFormValues, unknown>;
  onCancel: () => void;
};

export function LogisticUnitForm({
  defaultValues,
  companyOptions,
  excludeUnitId,
  ...
  const loadParentOptions = useCallback(
    async (companyId: string) => {
      ...
      try {
        const options = await logisticUnitGetParentOptionsAction({
          companyId,
          excludeUnitId,
        });
          ...
          <form.Field name="description">
            {(field) => (
              <TextareaField
                field={field}
                label="Description"
                placeholder="Brief description of the Logistic Unit"
              />
            )}
          </form.Field>
